...
${TESTDIR}/tests/CountedPointerTestClass.o: tests/CountedPointerTestClass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CountedPointerTestClass.o tests/CountedPointerTestClass.cpp


${TESTDIR}/tests/CountedPointerTestRunner.o: tests/CountedPointerTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CountedPointerTestRunner.o tests/CountedPointerTestRunner.cpp


${TESTDIR}/tests/YieldingIteratorsTestClass.o: tests/YieldingIteratorsTestClass.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/YieldingIteratorsTestClass.o tests/YieldingIteratorsTestClass.cpp


${TESTDIR}/tests/YieldingIteratorsTestRunner.o: tests/YieldingIteratorsTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/YieldingIteratorsTestRunner.o tests/YieldingIteratorsTestRunner.cpp
